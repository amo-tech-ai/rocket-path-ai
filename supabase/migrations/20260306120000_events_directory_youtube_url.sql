...
COMMENT ON VIEW public.events_directory IS 'Unified directory for /events: hosted + industry. Exposes cover_image_url, youtube_url (industry) for detail page.';

...
See `.claude/database-migration/SKILL.md` for the full workflow.
...
- `.claude/database-migration/SKILL.md` - Full workflow
- `.claude/supabase/references/` - SQL patterns and best practices
- `.agents/skills/supabase-postgres-best-practices/` - Advanced Postgres optimization

...
import { type Step1Data, type Step2Data } from '@/lib/pitchDeckSchema';
import { cn } from '@/lib/utils';
import { usePitchSuggestions } from '@/hooks/usePitchSuggestions';
import { Step2AISuggestionsPanel } from './step2/Step2AISuggestionsPanel';
...
export function WizardStep2({
  ...
  const [focusedField, setFocusedField] = useState<'problem' | 'core_solution' | 'differentiator' | null>(null);
  ...
  const handleFocus = (field: 'problem' | 'core_solution' | 'differentiator') => {
  ...
  const handleApplySuggestion = useCallback((field: string, text: string) => {
    const mappedField = field === 'differentiation' ? 'differentiator' : field;
    setFormData(prev => ({ ...prev, [mappedField]: text }));
        ...
        <div className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              onFocus={() => handleFocus('core_solution')}
              onBlur={handleBlur}
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              onFocus={() => handleFocus('differentiator')}
              onBlur={handleBlur}

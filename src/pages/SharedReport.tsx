...
export default function SharedReport() {
  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      // Transform data safely (same as ValidatorReport)
      ...
      <main className="pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-6 space-y-8">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="relative flex-shrink-0">
                <svg className="w-40 h-40 -rotate-90">
                  ...
                  <circle
                    cx="80" cy="80" r="70"
                    stroke="url(#scoreGradientShared)"
                    strokeWidth="12"
                    fill="none"
                    strokeLinecap="round"
                  ...
                  />
                  <defs>
                    <linearGradient id="scoreGradientShared" x1="0%" y1="0%" x2="100%" y2="0%">
          ...
          <div className="grid gap-6">
            <PublicReportSection number={1} title="Problem Clarity" content={details.problem_clarity} verified={report.verified} />
            <PublicReportSection number={2} title="Customer Use Case" content={details.customer_use_case} verified={report.verified} />

            {/* Market Sizing */}
            <PublicReportSection number={3} title="Market Sizing" verified={report.verified} citations={details.market_sizing?.citations}>
            ...
            {/* Competition */}
            <PublicReportSection number={4} title="Competition Deep Dive" verified={report.verified} citations={details.competition?.citations}>
            ...
            {/* Risks & Assumptions */}
            <PublicReportSection number={5} title="Risks & Assumptions" verified={report.verified}>
            ...
            {/* MVP Scope */}
            <PublicReportSection number={6} title="MVP Scope" content={details.mvp_scope} verified={report.verified} />

            {/* Next Steps */}
            <PublicReportSection number={7} title="Next Steps" verified={report.verified}>
            ...
            {(details.scores_matrix || details.market_factors || details.execution_factors) && (
              <PublicReportSection number={8} title="Scores Matrix" verified={report.verified}>
            ...
            {details.technology_stack && (
              <PublicReportSection number={9} title="Technology Stack" verified={report.verified}>
            ...
            {details.revenue_model && (
              <PublicReportSection number={10} title="Revenue Model" verified={report.verified}>
                <div className="mt-4 space-y-4">
            ...
            {/* Team & Hiring */}
            {details.team_hiring && (
              <PublicReportSection number={11} title="Team & Hiring" verified={report.verified}>
                <div className="mt-4 space-y-4">
            ...
            {details.key_questions && details.key_questions.length > 0 && (
              <PublicReportSection number={12} title="Key Questions" verified={report.verified}>
                <div className="mt-4 space-y-4">
            ...
            {details.resources_links && details.resources_links.length > 0 && (
              <PublicReportSection number={13} title="Resources & Links" verified={report.verified}>
                <div className="mt-4 space-y-4">
            ...
            {details.financial_projections && (
              <PublicReportSection number={14} title="Financial Projections" verified={report.verified}>
                        ...
                        <div className="h-64 w-full">
                          <ResponsiveContainer width="100%" height="100%">
                            <AreaChart data={chartData} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
                              <defs>
                                {scenarios.map((s, i) => (
                                  <linearGradient key={s.name} id={`grad-shared-${i}`} x1="0" y1="0" x2="0" y2="1">
                              ...
                              {scenarios.map((s, i) => (
                                <Area key={s.name} type="monotone" dataKey={s.name} stroke={colors[i % colors.length]} fill={`url(#grad-shared-${i})`} strokeWidth={2} />
                              ))}
                            </AreaChart>
                          </ResponsiveContainer>
                        </div>
...
// Lightweight report section for public view (no panel, no trace info)
...
function PublicReportSection({ number, title, content, verified, citations, children }: PublicReportSectionProps) {

...
export const CANVAS_BOX_CONFIG = [
  ...
  { 
    ...
    placeholder: 'e.g., AI-powered auto-categorization',
    row: 1, col: 2
  },
  { 
    ...
    placeholder: 'e.g., The fastest way for freelancers to stay tax-ready',
    row: 1, col: 3
  },
  { 
    ...
    placeholder: 'e.g., Proprietary AI tax classifier',
    row: 1, col: 4
  },
  { 
    ...
    placeholder: 'e.g., Freelancers earning over $50k',
    row: 1, col: 5
  },
  { 
    ...
    placeholder: 'e.g., Monthly Active Users, Retention (D30)',
    row: 2, col: 1
  },
  { 
    ...
    placeholder: 'e.g., TikTok influencer ads, LinkedIn content',
    row: 2, col: 2
  },
  { 
    ...
    placeholder: 'e.g., Cloud compute, AI inference, Payroll',
    row: 3, col: 'left'
  },
  { 
    ...
    placeholder: 'e.g., $15/mo subscriptions, Premium add-ons',
    row: 3, col: 'right'
  },
];

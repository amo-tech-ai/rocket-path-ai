...
def main():
    ...
    parser.add_argument(
        ...
        choices=["gemini-3-pro-image-preview", "gemini-3.1-flash-image-preview", "gemini-2.5-flash-image"],
    ...
    parser.add_argument(
        ...
        help="Thinking level for gemini-3.1-flash-image-preview (default: minimal)",
    )
    parser.add_argument(
        "--resolution",
        type=str,
    ...
    # Thinking config: --thinking-level takes priority, otherwise fall back to --include-thoughts
    if args.thinking_level:
        thinking_config = types.ThinkingConfig(
            thinking_level=args.thinking_level.capitalize(),
            include_thoughts=args.include_thoughts,
        )
    elif args.include_thoughts:

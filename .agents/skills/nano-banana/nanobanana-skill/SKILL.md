...
1. **GEMINI_API_KEY**: Configured in `~/.nanobanana.env` (sourced from `.env.local`)
2. **Python venv with deps installed**: `~/.nanobanana-venv/bin/python3` (google-genai, Pillow, python-dotenv, httpx[socks])
3. **Script**: `.agents/skills/nano-banana/nanobanana-skill/nanobanana.py`
...
2. Run the nanobanana script with appropriate parameters:
   ...
   ```bash
   ~/.nanobanana-venv/bin/python3 .agents/skills/nano-banana/nanobanana-skill/nanobanana.py --prompt "description of image" --output "filename.png"
   ```
...
2. Run with input images:
   ...
   ```bash
   ~/.nanobanana-venv/bin/python3 .agents/skills/nano-banana/nanobanana-skill/nanobanana.py --prompt "editing instructions" --input image1.png image2.png --output "edited.png"
   ```
...
```bash
~/.nanobanana-venv/bin/python3 .agents/skills/nano-banana/nanobanana-skill/nanobanana.py --prompt "A serene mountain landscape at sunset with a lake"
```

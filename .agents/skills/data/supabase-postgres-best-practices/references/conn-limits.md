...
-- On Supabase: max_connections is managed by Supabase based on your plan.
-- Use Supavisor connection pooler (port 6543) to multiplex many clients
-- over a small number of actual connections.

...
8. **Gantt Charts** - Project timelines, sprints, phases, milestones, dependencies → [references/gantt-diagrams.md](references/gantt-diagrams.md)
9. **Kanban** - Workflow stages, task boards (Todo / In Progress / Done), pipeline columns → [references/kanban-diagrams.md](references/kanban-diagrams.md)
10. **User Journey** - User experience mapping, satisfaction scoring → [references/user-journey-diagrams.md](references/user-journey-diagrams.md)
11. **Pie/Bar Charts** - Data visualization
...
- **[references/gantt-diagrams.md](references/gantt-diagrams.md)** - Tasks, sections, milestones, dateFormat/axisFormat, excludes, vert markers
- **[references/kanban-diagrams.md](references/kanban-diagrams.md)** - Columns, tasks, metadata (assigned, ticket, priority), ticketBaseUrl
...
- **[references/user-journey-diagrams.md](references/user-journey-diagrams.md)** - Sections, tasks, actor satisfaction scoring
